...
public class AuctionWeightShopRatioInfo implements Serializable, IEntity {
    ...
    private Long id;
    /**
     * 系数类型  1-店铺首页被分享的人数  2-店铺商品被分享的人数 3-通过永久二维码访问的人数 4-通过商品二维码访问的人数  5-店铺首页分享链接访问的人数
     * 6-商品分享链接访问的人数  7-店铺付款成交额
     * 8-店铺付款成交人数  9-店铺付款成交比数 10-店铺当面交易成交额 11-店铺退款额  12-店铺退款额人数
     */
    ...
    public AuctionWeightShopRatioInfo setRatioValue(Integer ratioValue) {
