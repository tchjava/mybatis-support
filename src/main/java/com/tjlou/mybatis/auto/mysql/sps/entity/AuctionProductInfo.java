...
public class AuctionProductInfo implements Serializable, IEntity {
     ...
     * 最终价格
     */
    @TableField("sucess_price")
    private Long sucessPrice;
    /**
     * 加价幅度
     */
    ...
    public Long getSucessPrice() {
        return sucessPrice;
    }

    public AuctionProductInfo setSucessPrice(Long sucessPrice) {
    ...
    public AuctionProductInfo setSuccessTime(Date successTime) {
    ...
    public AuctionProductInfo setLoseTime(Date loseTime) {
     ...
     * 最终价格
     */
    public static final String SUCESS_PRICE = "sucess_price";
