...
public class FpGeneratorClient {
    public static void runMybatisPlusGenerator() {
        InputStream is = PropertiesUtil.class.getResourceAsStream("/fp-generator.properties");
        PropertiesUtil.reload(is);
...
//        packageConfig.setModuleName("base");
        ...
        tc.setXml(null);
        tc.setEntity("./3.0/my.entity.java.vm");
        tc.setMapper("./3.0/mapper.java.vm");
        tc.setService("./3.0/service.java.vm");
        tc.setServiceImpl("./3.0/serviceImpl.java.vm");
